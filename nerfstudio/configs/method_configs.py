...
method_configs["depth-ziprefnerfacto"] = TrainerConfig(
    ...
    steps_per_eval_all_images=59000,
    steps_per_save=2000,
    ...
    optimizers={
        "proposal_networks": {
            "optimizer": RAdamOptimizerConfig(lr=3e-3, eps=1e-15, weight_decay=1e-6),
            "scheduler": ExponentialDecaySchedulerConfig(
                delay_steps=2000,
                warmup_steps=2000,
                lr_pre_warmup=1e-3,
